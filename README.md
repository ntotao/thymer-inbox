...
By default, the server runs on port **19501**. To use a different port:
...
1.  **Open the Web GUI**:
    Navigate to `https://<YOUR-SERVER-IP>:19501` (or your custom port).

    > [!IMPORTANT]
    > **Accept the Certificate**: You will see a "Not Secure" warning because of the self-signed certificate generated by the server. You **MUST** manually accept this (click "Advanced" -> "Proceed").
